...
// NOTE: previously referenced `bg-success`, `bg-warning`, `text-success-foreground`,
// `text-warning-foreground` — none of which are defined in styles.css. The excellent
// and fair badges silently fell back to the default badge style, erasing the visual
// distinction between conditions. Use Tailwind palette utilities that resolve at
// build time without requiring custom theme tokens.

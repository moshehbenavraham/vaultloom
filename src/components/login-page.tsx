...
export function LoginPage() {
  ...
  const Wrapper = ({ children }: { children: React.ReactNode }) => (
    <main
      id="main-content"
      tabIndex={-1}
      className="flex min-h-screen flex-col items-center justify-center bg-landing-bg px-4 focus:outline-none"
      style={dotGridBg}
    >
      ...
      <div className="w-full max-w-sm rounded-xl border border-landing-grid bg-landing-light p-8 shadow-sm">
        {children}
      </div>
    </main>
  );
        ...
        <form onSubmit={handleForgotPassword} className="mt-6 space-y-4" noValidate>
          <div className="space-y-2">
            ...
            <Input
              ...
              autoCapitalize="off"
              spellCheck={false}
              className="rounded-lg border-landing-grid bg-landing-light"
            />
          </div>
